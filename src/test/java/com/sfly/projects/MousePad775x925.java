...
public class MousePad775x925 extends BaseTest {

    @Test
    public void MousePad775x925() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\7.75x9.25 MousePad.json");
