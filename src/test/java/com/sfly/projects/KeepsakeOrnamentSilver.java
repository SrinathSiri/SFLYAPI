...
public class KeepsakeOrnamentSilver extends BaseTest {

    @Test
    public void KeepsakeOrnamentSilver() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\Keepsake Ornament - Silver.json");
