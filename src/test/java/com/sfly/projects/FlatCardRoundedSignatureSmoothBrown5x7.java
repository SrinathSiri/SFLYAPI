...
public class FlatCardRoundedSignatureSmoothBrown5x7 extends BaseTest {

    @Test
    public void FlatCardRoundedSignatureSmoothBrown5x7() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\RestAssuredPractice\\src\\test\\java\\com\\sfly\\payloads\\5x7FlatCardRoundedSignatureSmoothBrown.json");
