...
public class FramedPrint16x16ModernFrame16x16 extends BaseTest {

    @Test
    public void FramedPrint16x16ModernFrame16x16() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\16x16 Framed Print 16x16 Modern Frame.json");
