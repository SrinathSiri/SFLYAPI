...
public class CubeOrnament extends BaseTest {

    @Test
    public void CubeOrnament() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\Cube Ornament.json");
