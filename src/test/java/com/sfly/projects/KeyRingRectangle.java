...
public class KeyRingRectangle extends BaseTest {

    @Test
    public void KeyRingRectangle() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\Key Ring - Rectangle.json");
