...
public class WoodenPlaque5x7 extends BaseTest {

    @Test
    public void WoodenPlaque5x7() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\5x7 Wooden Plaque.json");
