...
public class Placemat11x17 extends BaseTest {

    @Test
    public void Placemat11x17() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\11x17 Placemat.json");
