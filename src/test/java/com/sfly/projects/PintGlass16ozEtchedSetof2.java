...
public class PintGlass16ozEtchedSetof2 extends BaseTest {

    @Test
    public void PintGlass16ozEtchedSetof2() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\16oz Pint Glass Etched Set of 2.json");
