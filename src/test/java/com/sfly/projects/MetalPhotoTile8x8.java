...
public class MetalPhotoTile8x8 extends BaseTest {

    @Test
    public void MetalPhotoTile8x8() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\8x8 Metal Photo Tile.json");
