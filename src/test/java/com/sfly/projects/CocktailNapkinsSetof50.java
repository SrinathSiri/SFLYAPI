...
public class CocktailNapkinsSetof50 extends BaseTest {

    @Test
    public void CocktailNapkinsSetof50() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\RestAssuredPractice\\src\\test\\java\\com\\sfly\\payloads\\Cocktail Napkins - Set of 50.json");
