...
public class CeramicTilewithStand6x6 extends BaseTest {

    @Test
    public void CeramicTilewithStand6x6() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\6x6 Ceramic Tile with Stand.json");
