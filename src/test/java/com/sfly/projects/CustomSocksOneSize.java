...
public class CustomSocksOneSize extends BaseTest {

    @Test
    public void CustomSocksOneSize() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\RestAssuredPractice\\src\\test\\java\\com\\sfly\\payloads\\CustomSocksOneSize.json");
