...
public class CelebrationPhotoBoard24x36 extends BaseTest {

    @Test
    public void CelebrationPhotoBoard24x36() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\24x36 Celebration Photo Board.json");
