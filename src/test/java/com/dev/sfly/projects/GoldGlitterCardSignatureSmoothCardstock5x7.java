...
public class GoldGlitterCardSignatureSmoothCardstock5x7 extends BaseTest {

    @Test
    public void GoldGlitterCardSignatureSmoothCardstock5x7() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\dev\\sfly\\payloads\\5x7 Gold Glitter Card Signature Smooth Cardstock.json");
