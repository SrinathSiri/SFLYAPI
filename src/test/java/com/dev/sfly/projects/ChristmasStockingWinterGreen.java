...
public class ChristmasStockingWinterGreen extends BaseTest {

    @Test
    public void ChristmasStockingWinterGreen() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\Christmas Stocking - Winter Green.json");
