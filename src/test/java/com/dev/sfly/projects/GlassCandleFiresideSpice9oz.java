...
public class GlassCandleFiresideSpice9oz extends BaseTest {

    @Test
    public void GlassCandleFiresideSpice9oz() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\9oz Glass Candle - Fireside Spice.json");
