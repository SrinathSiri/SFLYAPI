...
public class CardGameMemory extends BaseTest {

    @Test
    public void CardGameMemory() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\dev\\sfly\\payloads\\Card Game - Memory.json");
