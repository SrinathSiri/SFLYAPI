...
public class FarmhouseSign20x40 extends BaseTest {

    @Test
    public void FarmhouseSign20x40() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\20x40 Farmhouse Sign.json");
