...
public class VinylBanner24x48 extends BaseTest {

    @Test
    public void VinylBanner24x48() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\sfly\\payloads\\24x48 Vinyl Banner.json");
