...
public class TriFoldSmoothCardstock5x7 extends BaseTest {

    @Test
    public void TriFoldSmoothCardstock5x7() throws Exception {
        test.get().info("Preparing payload...");
        File file = new File("C:\\Users\\v-srinath.sirimalla\\AutomationWorkspace\\SFLYAPI\\src\\test\\java\\com\\dev\\sfly\\payloads\\5x7 Tri-Fold Smooth Cardstock.json");
